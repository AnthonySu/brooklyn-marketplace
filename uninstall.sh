#!/bin/bash
# uninstall.sh - Uninstaller for brooklyn-marketplace (removes entire marketplace)
#
# Usage:
#   ~/.claude/plugins/marketplaces/brooklyn-marketplace/uninstall.sh
#   OR
#   curl -fsSL https://raw.githubusercontent.com/AnthonySu/brooklyn-marketplace/main/uninstall.sh | bash
...
echo ""
echo -e "${RED}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${RED}║${NC}${BOLD}        Brooklyn Marketplace - Uninstaller                  ${NC}${RED}║${NC}"
echo -e "${RED}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
echo "  - brooklyn-marketplace directory and all plugins"
echo "  - All plugin entries from Claude Code settings"
echo "  - Plugin configurations (sync-config.json)"
echo "  - Local backups (sync-backups/)"
echo ""
...
# Remove plugin-specific configs
log_info "Removing plugin configurations..."
